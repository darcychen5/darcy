...
class Changeip(unittest.TestCase):
    ...
    def test_changeip(self):
        ...
        rtn = self.tests.tools.change_usx_ip(new_ip=new_ip, netmask=new_netmask, gateway='10.16.0.1')
